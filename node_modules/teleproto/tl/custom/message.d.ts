...
import { EditMessageParams, ForwardMessagesParams, MarkAsReadParams, SendMessageParams, UpdatePinMessageParams } from "../../client/messages";
...
export declare class CustomMessage extends SenderGetter {
     ...
     */
    fetchRichMessage(): Promise<Api.Message>;
    ...
    forwardTo(entity: EntityLike, params?: Omit<ForwardMessagesParams, "messages" | "fromPeer">): Promise<Api.Message[] | undefined>;
    ...
    markAsRead(params?: MarkAsReadParams): Promise<boolean | undefined>;
    react(reaction?: string | BigInteger | Api.TypeReaction | (string | BigInteger | Api.TypeReaction)[], big?: boolean, addToRecent?: boolean): Promise<Api.TypeUpdates | undefined>;
    getReactions(limit?: number, reaction?: string | Api.TypeReaction, offset?: string): Promise<Api.messages.MessageReactionsList | undefined>;
    copy(entity: EntityLike, params?: Omit<ForwardMessagesParams, "messages" | "fromPeer" | "dropAuthor">): Promise<Api.Message | undefined>;
