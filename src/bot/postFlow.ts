...
export async function startCreatePost(
  ctx: BotContext,
...
export async function choosePostAccount(
  ctx: BotContext,
  accountId: string
) {
  if (!ctx.from) return;
...
export async function handlePostText(
  ctx: BotContext,
  text: string
) {
...
export async function showPostGroups(
  ctx: BotContext,
  draftId: string
) {
  if (!ctx.from) return;
...
export async function togglePostGroup(
  ctx: BotContext,
  draftId: string,
  index: number
) {
...
export async function confirmPostGroups(
  ctx: BotContext,
  draftId: string
) {
  if (!ctx.from) return;
