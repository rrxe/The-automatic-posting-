...
export async function ensureOwnerAdmin(telegramId) {
    /*
    ...
    if (error) {
        throw new Error(`Failed to ensure owner admin: ${error.message}`);
    }
}
export async function attachReferral(referredUser, referrerTelegramId) {
