...
import { createPublishRun, executeSinglePublish } from "../services/publish.js";
...
export async function publishPost(ctx, draftId) {
    ...
    try {
        ...
        const result = await executeSinglePublish(user.id, draft.telegram_account_id, run.runId);
